...
const upcomingProjects = [
  { title: "Karibu Foundation Portal", category: "Non-Profit", status: "In Development" },
  { title: "Simba Properties", category: "Real Estate", status: "Coming Soon" },
  { title: "Chakula Kitchen", category: "Food & Beverage", status: "Coming Soon" },
];
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl">
              Every project is a partnership. Here are some of the websites and platforms we've delivered for clients across different industries.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/40">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-10">
            ...
            <p className="mt-3 text-muted-foreground">We're always working on new and exciting projects.</p>
          </motion.div>
          <div className="grid sm:grid-cols-3 gap-5 max-w-3xl mx-auto">
            {upcomingProjects.map((p) => (
              ...
              >
                <span className="text-xs text-secondary font-medium uppercase tracking-wider">{p.status}</span>
                <h3 className="mt-2 font-display font-bold text-foreground">{p.title}</h3>
