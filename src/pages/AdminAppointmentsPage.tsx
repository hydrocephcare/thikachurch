...
export default function AdminAppointmentsPage() {
  ...
  const loadAppointments = async () => {
    ...
    if (error) setLoginError(`Appointments could not be loaded: ${error.message}`);
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(firebaseAuth, async (firebaseUser) => {
      ...
      setIsAdmin(allowed);
      if (allowed) await loadAppointments();
      setChecking(false);
    });
