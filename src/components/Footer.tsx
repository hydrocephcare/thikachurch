      ...
      <div className="container mx-auto px-4 lg:px-8 py-20">
        <div className="grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            <Link to="/" className="font-display text-2xl font-extrabold text-foreground">KenyaAdverts<span className="text-primary">.co.ke</span></Link>
            <p className="mt-4 text-muted-foreground text-sm leading-relaxed max-w-sm">Website design and development for businesses, organisations and individuals in Kenya. From simple websites to e-commerce platforms and custom web applications.</p>
