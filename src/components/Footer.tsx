        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          {Object.entries(footerLinks).map(([title, links]) => <div key={title}>
              ...
              <div className="flex flex-col gap-2.5">
                {links.map(link => <Link key={link.label} to={link.href} className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-1 group">
                    {link.label}
