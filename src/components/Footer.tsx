      ...
      <div className="container mx-auto px-4 lg:px-8 py-20">
        <div className="grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground text-sm leading-relaxed max-w-sm">
              Kenya's leading church website development agency. We build professional, mobile-responsive websites with M-Pesa integration for churches and businesses across Kenya.
            </p>
            <div className="mt-6 flex flex-col gap-3">
              ...
              <span className="flex items-center gap-2 text-sm text-muted-foreground">
                <Mail className="h-4 w-4" />hello@omnexus.co.ke
              </span>
              <span className="flex items-center gap-2 text-sm text-muted-foreground">
                <MapPin className="h-4 w-4" />Nairobi, Kenya · Serving Nationwide
              </span>
            </div>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} OmnexusKE. All rights reserved.
          </p>
